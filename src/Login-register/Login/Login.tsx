...
<View style={loginRegistercss.titleviwe}>
    <Text style={loginRegistercss.title}> Wolcome back to</Text>
    <Text style={loginRegistercss.title1}> Jazo pay,</Text>
</View>
<View style={loginRegistercss.titleviwe1}>
    <Text style={loginRegistercss.title2}>Sign in to continue!</Text>
</View>

<View>
              <TextInput
                  style={[loginRegistercss.input, { marginBottom: 20 , marginTop:'15%'}, emailerror && loginRegistercss.errorInput]}
