...
const HomeSucces = ({navigation}:any) => {
    const Done = () => {
...
<View style={{marginTop:'10%', alignSelf:'center',flexDirection:'column', marginLeft:50}}>
    <Text style={{fontSize:30,}}>Application Submited!</Text>
    <Text style={{fontSize:15,marginTop:20}}>Your loan application was successfully
submited!</Text>
